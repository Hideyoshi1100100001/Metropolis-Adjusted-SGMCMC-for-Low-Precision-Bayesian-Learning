...
from util_tools.binarylib import AdaBin_Conv2d
...
parser.add_argument('-mhb', '--MH-batch-size', default=100, type=int,
...
parser.add_argument('--MHInterval', default=10, type=int, help='iterations between two MH tests')
...
def cifar():
    ...
    MHloader = torch.utils.data.DataLoader(
        trainset, batch_size=batchsize, shuffle=True, num_workers=1)
    ...
    return datasize, trainloader, MHloader, testloader

datasize, trainloader, MHloader, testloader = cifar()
