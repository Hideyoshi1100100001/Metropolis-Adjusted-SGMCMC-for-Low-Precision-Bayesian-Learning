...
from util_tools.binarylib import AdaBin_Conv2d, Maxout
...
def resnet18_1w1a(pretrained=False, sample=False, **kwargs):
    """Constructs a ResNet-18 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(sample, BasicBlock, [2, 2, 2, 2], **kwargs)
    if pretrained:
